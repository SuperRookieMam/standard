...
import com.standard.orm.componet.constant.PageInfo;
import com.standard.orm.componet.constant.WhereContext;
import com.standard.orm.componet.util.CopyFieldUtil;
import com.standard.orm.componet.util.MyClassUtil;
import com.standard.orm.componet.util.PresentWhereContextUtil;
...
public class BaseDaoImpl<T,ID extends Serializable> extends SimpleJpaRepository<T,ID > implements BaseDao<T,ID> {
    ...
    public BaseDaoImpl(Class<T> modelClass, EntityManager entityManager) {
    ...
    public <T> T updateByFieldContext(FieldContext fieldContext) {
        ...
        CopyFieldUtil.setFiled(fieldContext,criteriaUpdate,entityManager,root);
    ...
    public <T> int updateByFieldContextAndWhereContext (WhereContext whereContext, int flushSize) {
        ...
        Root<T> root =criteriaUpdate.from((Class<T>) clazz);
        CopyFieldUtil.setFiled(fieldContext,criteriaUpdate,entityManager,root);
