...
public class ResourceConfigure extends ResourceServerConfigurerAdapter {
    ...
    @Autowired
    private RequestAuthoritiesAccessDecisionVoter requestAuthoritiesAccessDecisionVoter;
    @Autowired
    ...
    public FilterSecurityInterceptor interceptor() {
      ...
      FilterSecurityInterceptor interceptor = new FilterSecurityInterceptor();
        //投票过滤
      List<AccessDecisionVoter<?>> voters = Collections.singletonList(requestAuthoritiesAccessDecisionVoter);
          //创建一个成功的控制权限
